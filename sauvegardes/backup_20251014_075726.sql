...
-- Started on 2025-10-14 07:57:27
...
456	plateforme_avance	gAWV-:1v8Y2H:ESprUwCgI1e0_cssqdfSgHS412wRLZ104KsgGwHCd1A	2025-10-14 07:57:25.935218+02
\.
...
48	reports.tasks.generate_critical_alerts	\N	()	{}	H	-54	2025-10-14 08:00:00+02	6161c95cbbaf48a8b8b166d9b9fe3d38	hourly_critical_alerts	\N	\N	\N
...
SELECT pg_catalog.setval('public.django_q_ormq_id_seq', 456, true);
...
SELECT pg_catalog.setval('public.import_export_exporthistory_id_seq', 249, true);
...
SELECT pg_catalog.setval('public.inventory_ajustementinventaire_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.inventory_lignecomptage_id_seq', 5, true);
...
SELECT pg_catalog.setval('public.inventory_sessioninventaire_id_seq', 7, true);
...
-- Completed on 2025-10-14 07:57:29
