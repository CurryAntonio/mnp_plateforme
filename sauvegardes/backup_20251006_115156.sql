...
-- Started on 2025-10-06 11:52:00
...
417	plateforme_avance	gAWV-:1v5hsq:LSTyNd-dE4nZ7SVj2MZcdkyiZy7ijiVVM2wI2wQuXWg	2025-10-06 11:51:56.480618+02
\.
...
46	reports.tasks.daily_reorder_calculation	\N	()	{'kwargs': {'depot': 'Principal'}}	D	-8	2025-10-07 04:00:00+02	b464ab1e441046568d1d63b550c3f7dd	daily_reorder_calculation	\N	\N	\N
48	reports.tasks.generate_critical_alerts	\N	()	{}	H	-23	2025-10-06 12:00:00+02	3543a6c12c7a4e21abfb894f9d8f1e16	hourly_critical_alerts	\N	\N	\N
47	reports.tasks.cleanup_old_analyses	\N	()	{'kwargs': {'days_to_keep': 90}}	W	-4	2025-10-08 05:00:00+02	2cbb91ab16664b1bb41aac56fb10afb5	weekly_cleanup	\N	\N	\N
\.
...
3	20.000	19.000	-1.000	2025-09-08 14:07:25.242728+02	Calcul automatique lors de la clôture	3	4	2
...
5	INV-20250908190350-2	2025-09-08 21:03:50.814484+02	2025-09-08 21:04:32.012203+02	TERMINEE	2
6	INV-20250910095950-2	2025-09-10 11:59:50.574107+02	2025-09-10 12:00:40.364129+02	TERMINEE	2
\.
...
3	PRD-003	Affichage	39	30	Unité	Bat A		2025-06-23 15:33:10.210044+02	2025-09-10 11:58:00.372924+02	2	7
...
1	PRD-001	Papier A4	101	20	RAM	Bat A	Papier	2025-06-20 11:55:10.340085+02	2025-10-06 11:32:32.100797+02	1	7
\.
...
SELECT pg_catalog.setval('public.django_q_ormq_id_seq', 417, true);
...
SELECT pg_catalog.setval('public.import_export_exporthistory_id_seq', 241, true);
...
SELECT pg_catalog.setval('public.inventory_ajustementinventaire_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.inventory_lignecomptage_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.inventory_sessioninventaire_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.journal_mouvement_id_seq', 20, true);
...
SELECT pg_catalog.setval('public.reports_reordermonitoring_id_seq', 15, true);
...
-- Completed on 2025-10-06 11:52:01
